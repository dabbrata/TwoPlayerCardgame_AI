...
def open_Octazirkel_file():
    quit()
    call(["python","OctaKor_Beta_Version.py"])

root = tk.Tk()
root.title("OCTAZIRKEL(hard)")
...
Button(right_frame, image=btnrestart2,command=open_Octazirkel_file, relief=RAISED,padx = "0",pady="0",borderwidth="0",bg="skyblue",fg="white",font=("Arial", 8)).grid(row=2, column=0, padx=5, pady=3, ipadx=10)
